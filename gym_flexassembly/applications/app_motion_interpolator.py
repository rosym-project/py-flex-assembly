"""Test mechanisms for the Motion Interpolator component.
:Author:
...
class MotionInterpolatorTest(object):
    def __init__(self):
        ...
        # run simultaneously.
        rospy.init_node('mit', anonymous=False)
        print("Init MotionInterpolatorTest (mit) node")
