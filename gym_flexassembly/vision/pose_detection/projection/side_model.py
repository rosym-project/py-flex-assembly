...
def build_model(num_classes=2, weights=None, device=None):
    model_ft = models.resnet18(pretrained=(weights is None))
    ...
    if weights is None:
        ...
        model_ft.load_state_dict(torch.load(weights, map_location=device), strict=True)
    return model_ft
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelfile', type=str, default='side_model.pth')
    ...
    torch.save(model_ft.state_dict(), args.modelfile)
